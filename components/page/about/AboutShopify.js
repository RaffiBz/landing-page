...
export default function AboutShopify() {
  return (
    <div
      id="7"
      className="bg-shopify-mb md:bg-shopify bg-no-repeat bg-contain lg:pb-[8.125rem] lg:pt-[8.125rem] pb-[31.75rem] pt-16 md:px-[3.25rem] mt-16 md:mt-20 items-center"
    >
