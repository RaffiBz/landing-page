...
export default function Shopify() {
  ...
  return (
    <div className="md:bg-gray md:px-4 lg:px-[3.75rem] mt-16 md:mt-0 md:py-16">
      ...
      <div className="bg-shopify-mb md:bg-shopify bg-no-repeat bg-contain xl:bg-cover rounded-[0.938rem] pb-[31.75rem] md:pb-[7rem] xl:pb-[8.125rem] pt-16 lg:pt-[4.5rem] xl:pt-[8.125rem] md:px-[3.25rem] items-center">
