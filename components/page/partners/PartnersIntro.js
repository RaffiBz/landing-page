  ...
  return (
    <div className="bg-white">
      <div className="bg-secondaryDark pt-[8rem] pb-[5.813rem] rounded-bl-[25rem]">
        ...
        <div className="relative flex justify-between px-[6.25rem]">
          <PartnersIntroItem
          ...
          />
          <div className="absolute top-[3.375rem] left-[34.875rem]">
            <Image src={vectorGreen} width={77} height={44} alt="vector" />
          </div>
          <div className="absolute -top-[1.813rem] right-[23.875rem]">
        ...
        <div className="relative flex">
          <div className="absolute top-[1.813rem] left-0">
            <Image src={dotsLeft} width={112} height={210} alt="dots" />
          </div>
          <div className="absolute top-[4.875rem] left-[5.188rem]">
            <Image src={vectorOrange} width={127} height={73} alt="vector" />
          </div>
          <div className="flex justify-between w-full max-w-[48.5rem] mx-auto mt-[1.438rem]">
            <PartnersIntroItem
          ...
          <div className="absolute top-[3.375rem] right-[3.875rem]">
            <Image src={vectorBlue} width={100} height={118} alt="vector" />
          </div>
          <div className="absolute -bottom-[4.438rem] right-0">
