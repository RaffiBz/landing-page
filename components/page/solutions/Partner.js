...
export default function Partner() {
  return (
    <div className="relative flex justify-between pt-[13.438rem]">
      ...
      {/* oval bg with text */}
      <div className="lg:flex justify-end bg-primaryDark bg-opacity-10 rounded-[25rem] pt-8 pb-[5.875rem] px-4 md:px-0 lg:pr-[11.313rem] w-full max-w-[54.5rem] lg:max-h-[32.625rem]">
