...
export default function Affiliate() {
  return (
    <div className="relative flex justify-between pt-[7rem]">
      ...
      {/* side image */}
      <div className="hidden md:block -mr-[12.5rem]">
        <Image width={644} height={431} src={affiliateMain} alt="main" />
      </div>
      {/* oval bg with text */}
      <div className="md:flex justify-end bg-orange bg-opacity-10 rounded-[25rem] py-8 px-4 md:px-0 md:pr-[11.313rem] w-full max-w-[54.5rem] md:max-h-[32.625rem]">
