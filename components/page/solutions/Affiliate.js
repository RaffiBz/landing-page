...
export default function Affiliate() {
  return (
    <div className="relative flex justify-between pt-[7rem]">
      ...
      {/* side image */}
      <div className="hidden lg:block -mr-[12.5rem] xl:-mr-[17.5rem]">
        <Image width={644} height={431} src={affiliateMain} alt="main" />
      </div>
      {/* oval bg with text */}
      <div className="lg:flex justify-end bg-orange bg-opacity-10 rounded-[25rem] py-8 px-4 md:px-0 lg:pr-[8rem] xl:pr-[11.313rem] w-full max-w-[54.5rem] lg:max-h-[32.625rem]">
