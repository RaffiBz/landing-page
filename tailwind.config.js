...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        dashboard: "url('/images/home/dashboard-bg.png')",
        "dashboard-mb": "url('/images/home/dashboard-bg-mb.png')",
        setup: "url('/images/home/setup-bg.svg')",
        "setup-mb": "url('/images/home/setup-bg-mb.svg')",
        plans: "url('/images/home/plans-bg.svg')",
        "plans-mb": "url('/images/home/plans-bg-mb.svg')",
